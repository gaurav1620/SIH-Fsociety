...
import { ActivityIndicator,Text, View, TouchableOpacity, StyleSheet , TextInput, Dimensions, ScrollView, Image, StatusBar} from 'react-native';
...
<ScrollView style={{height: 580, zIndex:1}}>
    ...
    <TouchableOpacity style={{backgroundColor:'#000'}} onPress={this.sendResponse}>
