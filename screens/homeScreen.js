...
export default class HomeScreen extends React.Component {
  ...
  state={
    ...
    async componentDidMount(){
        try{
            fetch("https://sih-fsociety.herokuapp.com/complaints",{
                method:'GET',
                headers:{
                ...
                this.setState({isLoading:false,complaints:x})
            }).catch((e)=>{
  ...
  sendResponse = () =>{
        ...
        fetch("http://sih-fsociety.herokuapp.com/complaint",{
            method:'POST',
            headers:{
                Accept:'application/json',
                'Content-Type':'application/json',
  ...
  render() {
    ...
    const chatY = this.mode.interpolate({
      ...
      const data = this.state.complaints;
          ...
          width:Dimensions.get('window').width, alignSelf:'center',
           ...
           <TouchableOpacity style={{justifyContent:'center', alignSelf:'center', alignItems:'center', }}>
            <FontAwesome5 name='times' style={{margin:10, marginTop:20}} size={23} color='gray' onPress={() => this.closeModal()}/>
             ...
             <View>
             <Text style={{...styles.fieldTitle, marginHorizontal:20, marginTop:20}}>Title</Text>
             <TextInput
             ...
             <View style={{marginTop:10 , marginHorizontal:20 , flexDirection:'row' , justifyContent:'space-between'}}>
                 ...
                 <Text style={{...styles.fieldTitle,marginTop:15}}>Level</Text>
                <Picker
                 ...
                 <View style={{flex:1, paddingLeft:5}}>
                    ...
                    <Picker
                        ...
                        <Picker.Item label="Admission" value="Finance"/>
                        <Picker.Item label="Finance" value="Finance"/>
                        <Picker.Item label="Time Table" value="Time Table"/>
                        <Picker.Item label="Examination" value="Examination"/>
                        <Picker.Item label="Re-Evaluation" value="Re-Evaluation"/>
                    </Picker>
                 </View>
             ...
             <View style={{flexDirection:'row', width:Dimensions.get('window').width-40,
               ...
               <Text style={{...styles.fieldTitle, marginTop:20}}>Description</Text>
            ...
            <TouchableOpacity onPress={this.sendResponse}>
            <Image
